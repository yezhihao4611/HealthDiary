package com.tz.healthdiary.custom;
...
public class ColorArcProgressBar extends View {
    ...
    private void initCofig(Context context, AttributeSet attrs) {
        ...
        int color6 = a.getColor(R.styleable.ColorArcProgressBar_front_color6, color1);
        int color7 = a.getColor(R.styleable.ColorArcProgressBar_front_color7, color1);
        int color8 = a.getColor(R.styleable.ColorArcProgressBar_front_color8, color1);

        colors = new int[]{color1, color2, color3, color4, color5, color6, color7, color8, color8};
